<?php
/**
 * Widget API: WP_Custom_Widget_Categories class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class WP_Custom_Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => __( 'A list or dropdown of categories.', 'lifestyle' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'custom-categories', __( 'Custom Categories', 'lifestyle' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Categories', 'lifestyle' );
		...
		if ( $d ) {
			...
			$cat_args['show_option_none'] = __( 'Select Category', 'lifestyle' );
